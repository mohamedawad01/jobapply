...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2441539079ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=job&table=users">`job`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=job&table=apply_jobs">`job`.`apply_jobs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=job&table=apply">`job`.`apply`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=friday_laravel&table=users">`friday_laravel`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=friday_laravel&table=notes">`friday_laravel`.`notes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=friday_laravel&table=category_book">`friday_laravel`.`category_book`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=friday_laravel&table=categories">`friday_laravel`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=friday_laravel&table=books">`friday_laravel`.`books`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=friday_laravel&table=migrations">`friday_laravel`.`migrations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=friday_laravel&table=personal_access_tokens">`friday_laravel`.`personal_access_tokens`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="743f2954642f586a4d583f5d4d4c5153">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="job" targettable="apply_jobs">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `apply_jobs`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="job" targettable="apply_jobs">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `apply_jobs`  
ORDER BY `apply_jobs`.`photo`  ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="job" targettable="apply_jobs">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `apply_jobs`  
ORDER BY `apply_jobs`.`photo`  DESC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="job" targettable="apply_jobs">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `apply_jobs`  
ORDER BY `apply_jobs`.`id` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="job" targettable="apply_jobs">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `apply_jobs` ORDER BY `id` ASC </span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="job" targettable="apply_jobs">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `apply_jobs`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="job" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
